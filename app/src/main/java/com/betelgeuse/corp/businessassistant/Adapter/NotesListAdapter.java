...
import com.betelgeuse.corp.businessassistant.NotesClickListener;
...
public class NotesListAdapter extends  RecyclerView.Adapter<NotesViewHolder>{
    ...
    public NotesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new NotesViewHolder(LayoutInflater.from(context).inflate(R.layout.notes_card, parent, false));
    }
